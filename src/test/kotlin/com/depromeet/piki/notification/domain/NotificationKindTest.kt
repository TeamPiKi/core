    ...
    companion object {
        ...
        fun 파생_케이스(): List<Arguments> =
            listOf(
                ...
                Arguments.of(NotificationType.ITEM_PARSING_RECOVERED, NotificationKind.WISH, NotificationKind.WISH),
                Arguments.of(NotificationType.ITEM_PARSING_RECOVERED, NotificationKind.TOURNAMENT, NotificationKind.TOURNAMENT),
                Arguments.of(NotificationType.ITEM_PARSING_RECOVERED, null, NotificationKind.WISH),
                Arguments.of(NotificationType.ITEM_REFRESH_COMPLETED, NotificationKind.WISH, NotificationKind.WISH),
                Arguments.of(NotificationType.ITEM_REFRESH_COMPLETED, NotificationKind.TOURNAMENT, NotificationKind.TOURNAMENT),
                Arguments.of(NotificationType.ITEM_REFRESH_COMPLETED, null, NotificationKind.WISH),
                Arguments.of(NotificationType.ITEM_REFRESH_FAILED, NotificationKind.WISH, NotificationKind.WISH),
                Arguments.of(NotificationType.ITEM_REFRESH_FAILED, NotificationKind.TOURNAMENT, NotificationKind.TOURNAMENT),
                Arguments.of(NotificationType.ITEM_REFRESH_FAILED, null, NotificationKind.WISH),
